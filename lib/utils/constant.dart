...
class Constant {
  ...
  static String isGoogleBannerAdsEnabled = "0";
  static String isGoogleInterstitialAdsEnabled = "0";
  static String isGoogleNativeAdsEnabled = "0";
  ...
  static LeafLocation defaultLocation = LeafLocation(
    city: LocalizedString(canonical: 'Global Search'),
    state: LocalizedString(canonical: 'All Regions'),
    country: LocalizedString(canonical: 'Worldwide'),
    radius: 80000.0, // Expanded to cover the whole world for testing
    latitude: 23.232639,
