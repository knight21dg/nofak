...
import 'package:nofak/ui/screens/widgets/full_screen_image_view.dart';
import 'package:nofak/ui/screens/widgets/gallery_view.dart';
...
import 'package:nofak/utils/error_filter.dart';
...
class UiUtils {
  static void showError(BuildContext context, dynamic error) {
    String message = ErrorFilter.getTranslatedFirebaseAuthException(
      context,
      error: error,
    );
    showBlurredDialoge(
...
static Widget getImage(
    ...
    return CachedNetworkImage(
      ...
      width: width,
      height: height,
      memCacheWidth: width != null && width.isFinite && width > 0 ? (width * 2).round() : null,
      memCacheHeight: height != null && height.isFinite && height > 0 ? (height * 2).round() : null,
  ...
  static void insufficientCreditsDialog(BuildContext context) async {
    UiUtils.showBlurredDialoge(
      context,
      dialoge: BlurredDialogBox(
        title: 'insufficientCredits'.translate(context),
        acceptButtonName: 'buyCredits'.translate(context),
        ...
        content: StatefulBuilder(
          builder: (context, update) {
            return CustomText('insufficientCreditsMsg'.translate(context));
          },
        ),
