...
import 'package:nofak/utils/network_request_interseptor.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class ApiException implements Exception {
  ApiException(this.errorMessage, {this.details});
...
class Api {
  ...
  static String creditPackages = "credit-packages";
  static String purchaseCredits = "purchase-credits";
  static String creditRules = "get-credit-rules";
  ...
  static String getTechniciansApi = "get-technicians";
  static String updateAvailabilityApi = "update-availability";
  static String sendJobRequestApi = "send-job-request";
  static String getJobRequestsApi = "get-job-requests";
  static String updateJobRequestStatusApi = "update-job-request-status";

  static String sendMessageApi = "send-message";
  static String getChatListApi = "chat-list";
  static String itemOfferApi = "item-offer";
  static String deductCallCreditsApi = "deduct-call-credits";
  ...
  static Future<Map<String, dynamic>> post({
    ...
    try {
      ...
      if (resp['error'] ?? false) {
        throw ApiException(resp['message'].toString(), details: resp['details']);
      }
