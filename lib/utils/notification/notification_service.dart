...
import 'package:nofak/data/model/chat/chat_message_modal.dart';
...
class NotificationService {
  ...
  static Future<void> registerListeners(context) async {
    try {
      ...
      // Fetch initial token and update server
      ...
      messagingInstance.onTokenRefresh.listen((token) {
        updateFCMToken(token);
      });
    } catch (e) {
      debugPrint("Error in registerListeners: $e");
    }
  }

  static void updateFCMToken(String token) async {
    try {
