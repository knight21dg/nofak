...
class InAppPurchaseManager {
    ...
    if (packageId != null) {
      ...
      UiUtils.showBlurredDialoge(context,
          dialoge: BlurredDialogBox(
            ...
            content:
                 CustomText("purchaseCompletedSuccessfully".translate(context)),
  ...
  void paymentCancelDialog(BuildContext context) {
    UiUtils.showBlurredDialoge(
      context,
      dialoge: BlurredDialogBox(
        title: "purchaseCanceled".translate(context),
        showCancelButton: false,
        acceptTextColor: context.color.buttonColor,
        content:  CustomText("purchaseHasBeenCanceled".translate(context)),
        isAcceptContainerPush: true,
  ...
  void paymentErrorDialog(BuildContext context, PurchaseDetails purchase) {
    UiUtils.showBlurredDialoge(
      context,
      dialoge: BlurredDialogBox(
        title: "purchaseError".translate(context),
        showCancelButton: false,
        acceptTextColor: context.color.buttonColor,
