...
class AppLocalization {
  ...
  Future loadJson() async {
    ...
    if (HiveUtils.getLanguage() != null &&
      ...
      Map<String, dynamic> serverJson = Map<String, dynamic>.from(HiveUtils.getLanguage()['data']);
      // Merge server translations over local translations
      mappedJson.addAll(serverJson);
    }
