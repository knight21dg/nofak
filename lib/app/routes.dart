import 'package:nofak/ui/screens/ad_details_screen.dart';
import 'package:nofak/ui/screens/advertisement/my_advertisment_screen.dart';
import 'package:nofak/ui/screens/auth/login/forgot_password.dart';
import 'package:nofak/ui/screens/auth/login/login_screen.dart';
import 'package:nofak/ui/screens/auth/sign_up/mobile_signup_screen.dart';
import 'package:nofak/ui/screens/auth/sign_up/signup_main_screen.dart';
import 'package:nofak/ui/screens/auth/sign_up/signup_screen.dart';
import 'package:nofak/ui/screens/auth/choose_account_type.dart';
import 'package:nofak/ui/screens/blogs/blog_details.dart';
import 'package:nofak/ui/screens/blogs/blogs_screen.dart';
import 'package:nofak/ui/screens/chat/blocked_user_list_screen.dart';
import 'package:nofak/ui/screens/faqs_screen.dart';
import 'package:nofak/ui/screens/favorite_screen.dart';
import 'package:nofak/ui/screens/filter_screen.dart';
import 'package:nofak/ui/screens/home/category_list.dart';
import 'package:nofak/ui/screens/home/change_language_screen.dart';
import 'package:nofak/ui/screens/home/search_screen.dart';
import 'package:nofak/ui/screens/home/widgets/categoryFilterScreen.dart';
import 'package:nofak/ui/screens/home/widgets/posted_since_filter.dart';
import 'package:nofak/ui/screens/home/widgets/sub_category_filter.dart';
import 'package:nofak/ui/screens/item/add_item_screen/add_item_details.dart';
import 'package:nofak/ui/screens/item/add_item_screen/confirm_location_screen.dart';
import 'package:nofak/ui/screens/item/add_item_screen/more_details.dart';
import 'package:nofak/ui/screens/item/add_item_screen/select_category.dart';
import 'package:nofak/ui/screens/item/add_item_screen/widgets/pdf_viewer.dart';
import 'package:nofak/ui/screens/item/add_item_screen/widgets/success_item_screen.dart';
import 'package:nofak/ui/screens/item/items_list.dart';
import 'package:nofak/ui/screens/item/job_application/job_application_form.dart';
import 'package:nofak/ui/screens/item/job_application/job_application_list_screen.dart';
import 'package:nofak/ui/screens/item/my_items_screen.dart';
import 'package:nofak/ui/screens/item/section_wise_item_screen.dart';
import 'package:nofak/ui/screens/location/location_screen.dart';
import 'package:nofak/ui/screens/location/widgets/location_map_picker.dart';
import 'package:nofak/ui/screens/location_permission_screen.dart';
import 'package:nofak/ui/screens/main_activity.dart';
import 'package:nofak/ui/screens/my_review_screen.dart';
import 'package:nofak/ui/screens/onboarding/onboarding_screen.dart';
import 'package:nofak/ui/screens/seller/seller_intro_verification.dart';
import 'package:nofak/ui/screens/seller/seller_profile.dart';
import 'package:nofak/ui/screens/seller/seller_verification.dart';
import 'package:nofak/ui/screens/seller/seller_verification_complete.dart';
import 'package:nofak/ui/screens/settings/contact_us.dart';
import 'package:nofak/ui/screens/settings/notification_detail.dart';
import 'package:nofak/ui/screens/settings/notifications.dart';
import 'package:nofak/ui/screens/settings/setting_pages.dart';
import 'package:nofak/ui/screens/sold_out_bought_screen.dart';
import 'package:nofak/ui/screens/splash_screen.dart';
import 'package:nofak/ui/screens/sub_category/sub_category_screen.dart';

import 'package:nofak/ui/screens/subscription/transaction_history_screen.dart';
import 'package:nofak/ui/screens/user_profile/edit_profile.dart';
import 'package:nofak/ui/screens/widgets/maintenance_mode.dart';
import 'package:nofak/ui/screens/home/technician_marketplace_screen.dart';
import 'package:nofak/ui/screens/item/job_request_list_screen.dart';
import 'package:nofak/ui/screens/credit_packages/credit_packages_screen.dart';
...
class Routes {
  ...
  static const String technicianMarketplace = 'technicianMarketplace';
  ...
  static const String creditPackagesRoute = 'creditPackagesRoute';
  ...
  static const String jobRequestsList = '/jobRequestsList';
  ...
  static bool _isDynamicRoute(String? routeName) {
    return routeName?.contains('/ad-details/') == true ||
        ...
        routeName?.contains('/blog-details/') == true;
  }
  ...
  static Route _handleDynamicRoute(RouteSettings routeSettings) {
    ...
    } else if (type == 'blog-details') {
      return _handleBlogDetailsRoute(value);
    }

    return _defaultRoute();
  }

  /// Handles blog details route
  static Route _handleBlogDetailsRoute(String value) {
    if (previousRoute.isEmpty) {
      return MaterialPageRoute(builder: (_) => SplashScreen(blogSlug: value));
    }

    // Since BlogDetails usually requires a model, we would ideally fetch it here.
    // For now, we redirect to the splash screen if opened externally to allow initialization.
    return MaterialPageRoute(builder: (_) => SplashScreen(blogSlug: value));
  }
  ...
  static Route _handleStaticRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case jobRequestsList:
        return JobRequestsListScreen.route(routeSettings);
      case blogDetailsScreenRoute:
        return BlogDetails.route(routeSettings);

      case creditPackagesRoute:
      ...
      case technicianMarketplace:
        return MaterialPageRoute(builder: (_) => const TechnicianMarketplaceScreen());
      case faqsScreen:
