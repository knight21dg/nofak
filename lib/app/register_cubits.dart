import 'package:nofak/data/cubits/add_item_review_cubit.dart';
...
import 'package:nofak/data/cubits/auth/login_cubit.dart';
import 'package:nofak/data/cubits/auth/user_profile_cubit.dart';
import 'package:nofak/data/cubits/subscription/assign_free_package_cubit.dart';
import 'package:nofak/data/cubits/subscription/get_payment_intent_cubit.dart';
import 'package:nofak/data/cubits/category/fetch_category_cubit.dart';
import 'package:nofak/data/cubits/category/fetch_sub_categories_cubit.dart';
import 'package:nofak/data/cubits/chat/block_user_cubit.dart';
...
import 'package:nofak/data/cubits/chat/get_seller_chat_users_cubit.dart';
...
import 'package:nofak/data/cubits/chat/unblock_user_cubit.dart';
import 'package:nofak/data/cubits/company_cubit.dart';
...
import 'package:nofak/data/cubits/fetch_blogs_cubit.dart';
import 'package:nofak/data/cubits/fetch_faqs_cubit.dart';
import 'package:nofak/data/cubits/fetch_item_buyer_cubit.dart';
import 'package:nofak/data/cubits/fetch_my_reviews_cubit.dart';
import 'package:nofak/data/cubits/fetch_notifications_cubit.dart';
import 'package:nofak/data/cubits/home/fetch_home_all_items_cubit.dart';
import 'package:nofak/data/cubits/home/fetch_home_screen_cubit.dart';
import 'package:nofak/data/cubits/home/fetch_section_items_cubit.dart';
...
import 'package:nofak/data/cubits/item/fetch_item_from_category_cubit.dart';
import 'package:nofak/data/cubits/item/fetch_my_featured_items_cubit.dart';
import 'package:nofak/data/cubits/item/fetch_my_item_cubit.dart';
import 'package:nofak/data/cubits/item/fetch_popular_items_cubit.dart';
...
import 'package:nofak/data/cubits/item/search_item_cubit.dart';
import 'package:nofak/data/cubits/location/leaf_location_cubit.dart';
import 'package:nofak/data/cubits/location/location_cubit.dart';
import 'package:nofak/data/cubits/my_item_review_report_cubit.dart';
...
import 'package:nofak/data/cubits/seller/fetch_seller_verification_field.dart';
import 'package:nofak/data/cubits/seller/fetch_verification_request_cubit.dart';
import 'package:nofak/data/cubits/seller/send_verification_field_cubit.dart';
import 'package:nofak/data/cubits/setting_pages_cubit.dart';
import 'package:nofak/data/cubits/slider_cubit.dart';
import 'package:nofak/data/cubits/subscription/bank_transfer_update_cubit.dart';

import 'package:nofak/data/cubits/subscription/fetch_user_credit_limit_cubit.dart';
import 'package:nofak/data/cubits/subscription/in_app_purchase_cubit.dart';
...
import 'package:nofak/data/cubits/system/get_api_keys_cubit.dart';
import 'package:nofak/data/cubits/system/language_cubit.dart';
import 'package:nofak/data/cubits/system/notification_cubit.dart';
import 'package:nofak/data/cubits/system/user_details.dart';
import 'package:nofak/data/cubits/utility/fetch_transactions_cubit.dart';
import 'package:nofak/data/cubits/utility/item_edit_global.dart';
...
class RegisterCubits {
  List<SingleChildWidget> providers = [
    BlocProvider(create: (context) => FetchTechniciansCubit()),
    BlocProvider(create: (context) => FetchJobRequestsCubit()),
    BlocProvider(create: (context) => ManageJobRequestCubit()),
