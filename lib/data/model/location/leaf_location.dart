...
class LeafLocation {
  LeafLocation({
    ...
    _locationParts = [
      if (area != null) area!.localized,
      if (city != null) city!.localized,
      if (state != null) state!.localized,
      if (country != null) country!.localized,
    ];
  ...
  factory LeafLocation.fromJson(Map<String, dynamic> json) => LeafLocation(
    ...
    radius: json['radius'] as double? ?? 25.0,
  ...
  LeafLocation copyWith({
    ...
    return LeafLocation(
      ...
      longitude: longitude,
      placeId: placeId,
      radius: radius ?? this.radius ?? 25.0,
    );
  }
  ...
  bool get isDefault =>
      !hasCoordinates ||
      (latitude == Constant.defaultLocation.latitude &&
          longitude == Constant.defaultLocation.longitude);
