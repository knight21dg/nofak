class VerificationRequestModel {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.verificationFieldValues != null) {
      data['verification_field_values'] = this.verificationFieldValues!
          .map((v) => v.toJson())
          .toList();
    }
    return data;
...
class VerificationFieldValues {
  ...
  VerificationFieldValues.fromJson(Map<String, dynamic> json) {
    ...
    languageId = json['language_id'] is String
  ...
  @override
  String toString() {
    return 'VerificationFieldValues{id: $id, verificationFieldId: $verificationFieldId, value: $value, userId: $userId, verificationRequestId: $verificationRequestId, languageId: $languageId, createdAt: $createdAt, updatedAt: $updatedAt}';
  }
}
