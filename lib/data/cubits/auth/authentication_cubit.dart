...
import 'package:nofak/utils/login/apple_login/apple_login.dart';
import 'package:nofak/utils/login/email_login/email_login.dart';
import 'package:nofak/utils/login/google_login/google_login.dart';
...
import 'package:nofak/utils/login/phone_login/phone_login.dart';
...
class AuthenticationFail extends AuthenticationState {
  ...
  const AuthenticationFail(this.error);
}
...
class AuthenticationCubit extends Cubit<AuthenticationState> {
  ...
  bool _isTwilioVerificationRequired() {
    return payload is PhoneLoginPayload;
  }
