...
class FetchItemFromCategoryCubit extends Cubit<FetchItemFromCategoryState> {
  ...
  void setInitialState() {
    emit(FetchItemFromCategoryInitial());
  }
  ...
  Future<void> fetchItemFromCategory({
    ...
    try {
      ...
      emit(FetchItemFromCategoryFailure(e.toString()));
    }
  }
  ...
  Future<void> fetchItemFromCategoryMore({
    ...
    try {
      if (state is FetchItemFromCategorySuccess) {
        ...
        emit(
          (state as FetchItemFromCategorySuccess).copyWith(isLoadingMore: true),
        );
        ...
        List<ItemModel> updatedList = List<ItemModel>.from(item.itemModel)
