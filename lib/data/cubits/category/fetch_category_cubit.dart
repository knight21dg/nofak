...
import 'package:nofak/data/repositories/category_repository.dart';
...
class FetchCategoryCubit extends Cubit<FetchCategoryState> {
  ...
  Future<void> fetchCategories({
    ...
    try {
      ...
      print("FetchCategoryCubit: Successfully fetched ${categories.modelList.length} categories");
      ...
      print("FetchCategoryCubit: Error fetching categories: $e");
