...
const Color territoryColor_ = Color(0xFF2E5BFF);
...
///Dark Theme Colors
Color primaryColorDark = const Color(0xff0D0D0D);
Color secondaryColorDark = const Color(0xff1A1A1A);
const Color territoryColorDark = Color(0xff2E5BFF);
...
Color lightTextColorDarkTheme = const Color(0xffFDFDFD).withValues(alpha: 0.7);
...
const Color successMessageColor = Color(0xff2E5BFF);
