...
class SellerVerificationScreen extends StatefulWidget {
  ...
  SellerVerificationScreen({super.key, required this.isResubmitted, this.type = 'seller'});
    ...
    Future.delayed(Duration.zero, () {
      if (widget.isResubmitted == true) {
        context
            ...
            .fetchVerificationRequests(type: widget.type);
      }
                  ...
                  setState(() {
                    ...
                    Future.delayed(Duration.zero, () {
                      context
                          ...
                          .fetchSellerVerificationFields(type: widget.type);
                    });
                  });
