...
import 'package:nofak/ui/screens/location/widgets/place_api_search_bar.dart';
...
class _LocationMapPickerState extends State<LocationMapPicker> {
  ...
  void initState() {
    ...
    _controller.addListener(() {
      ...
      //
      // If the current radius equals 25.0, update it with the
      // controller's latest radius value (usually restored from persistence).
      if (_radiusNotifier.value == 25.0) {
        _radiusNotifier.value = max(_controller.radius, 25.0);
      }
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (_controller.data.location.isDefault) {
