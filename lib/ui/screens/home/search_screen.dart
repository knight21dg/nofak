  ...
  static Route route(RouteSettings settings) {
    ...
    return MaterialPageRoute(
      builder: (context) => MultiBlocProvider(
        ...
        child: SearchScreen(autoFocus: arguments?['autoFocus']),
      ),
    );
  }
...
class SearchScreenState extends State<SearchScreen>
  ...
  late final LeafLocation? currentLocation;

  @override
  void initState() {
    super.initState();
    Constant.itemFilter = null;
    currentLocation = context.read<LeafLocationCubit>().state;
              ...
              GestureDetector(
                onTap: () {
                  Navigator.pushNamed(
                    context,
                    Routes.filterScreen,
                    arguments: {"from": "search", "categoryList": categoryList},
                  ).then((value) {
                ...
                child: Container(
                  ...
                  child: Center(
                    child: UiUtils.getSvg(
                      filter != null ? AppIcons.filterByIcon : AppIcons.filter,
                      color: context.color.territoryColor,
                    ),
                  ),
                ),
    ...
    return BlocConsumer<SearchItemCubit, SearchItemState>(
      ...
      builder: (context, searchState) {
        bool hasSearchResults =
            searchState is SearchItemSuccess &&
            searchState.searchedItems.isNotEmpty;

        ScrollController activeController = hasSearchResults
            ? controller
            : popularController;
                    ...
                    return Row(
                      children: [
                        ...
                        Expanded(
                          child: RichText(
                            text: TextSpan(
                              text: "${items[index].translatedName!}\tin\t",
                              style: TextStyle(
                                color: context.color.textDefaultColor
