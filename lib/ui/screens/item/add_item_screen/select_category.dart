...
import 'package:nofak/ui/screens/item/add_item_screen/widgets/category.dart';
...
import 'package:nofak/utils/touch_manager.dart';
...
class _SelectCategoryScreenState extends CloudState<SelectCategoryScreen> {
  ...
  void initState() {
    super.initState();
    debugPrint("SelectCategoryScreen: initState called");
    CloudState.cloudData.clear();
...
class _SelectNestedCategoryState extends CloudState<SelectNestedCategory> {
  ...
  void categoryClickHandler(CategoryModel categoryModel, int index) {
