...
import 'package:nofak/ui/screens/chat/chat_audio/widgets/chat_widget.dart';
import 'package:nofak/ui/screens/chat/chat_audio/widgets/record_button.dart';
import 'package:nofak/ui/screens/widgets/animated_routes/transparant_route.dart';
...
import 'package:nofak/utils/notification/chat_message_handler.dart';
                                        ...
                                        listener: (context, unblockState) {
                                          if (unblockState
                                            ...
                                            HelperUtils.showSnackBarMessage(
                                              ...
                                              is UnblockUserFail) {
                                            UiUtils.showError(context, unblockState.error);
                                          }
                                        },
                                        child: Container(
                                                        ...
                                                        onPressed: () async {
                                                          try {
                                                            if (messageAttachment ==
                                                              ...
                                                              pickedAttachment = await FilePicker
                                                                  .platform
                                                                  .pickFiles(
                                                                    allowMultiple:
                                                                        false,
